var store = [{
        ...
        "title": "React - Styling",
        "excerpt":"In the last two post we covered JSX and Props, now it’s time to move forward in our journey in React and the next stop is styling the components. There are various ways to style a component in React : Inline styles CSS file SASS file CSS modules CSS-in-JS librariesWe...","categories": ["blog","react"],
        "tags": [],
